...
export const compactActionSchema = {
  ...
  properties: {
    ...
    action: {
      ...
      description:
        'Action route to run for selected object_type (run/status/result/validate/list_types/create_transport/runProfiling/viewProfile/viewProfiles/viewDump/viewDumps).',
    },
    class_name: { type: 'string' },
    program_name: { type: 'string' },
    tests: {
