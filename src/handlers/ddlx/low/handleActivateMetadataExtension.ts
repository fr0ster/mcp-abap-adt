...
import { AxiosResponse, return_error, return_response, logger as baseLogger, getMa
import { AbapConnection } from '@mcp-abap-adt/connection';nagedConnection, restoreSessionInConnection } from '../../../lib/utils';
 ...
 */
export async function handleActivateMetadataExtension(connection: AbapConnection, args: ActivateMetadataExtensionArgs) {
  try {
    const {
      name,
      session_id,
