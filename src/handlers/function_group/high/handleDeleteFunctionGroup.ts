/**
 * DeleteFunctionGroup Handler - Delete ABAP FunctionGroup via ADT deletion API
 *
...
export const TOOL_DEFINITION = {
  ...
  description:
    'Delete an ABAP function group from the SAP system via ADT deletion API. Transport request optional for $TMP objects.',
  inputSchema: {
    type: 'object',
    properties: {
      function_group_name: {
...
export async function handleDeleteFunctionGroup(
  ...
  return answer(
    { tool: 'DeleteFunctionGroup', detail },
    () =>
      deleteIfDeletable(
        createAdtClient(connection, logger).getFunctionGroup(
