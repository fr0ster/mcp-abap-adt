...
import { validateTableName } from '@mcp-abap-adt/adt-clients/dist/core/table';

export const TOOL_DEFINITION = {
  name: "ValidateTable",
  description: "Validate an ABAP table name before creation. Checks if the name is valid and available. Can use session_id and session_state from GetSession to maintain the same session.",
  inputSchema: {
    type: "object",
    properties: {
      table_name: {
...
export async function handleValidateTable(args: any) {
  try {
    ...
    try {
      // Validate table using table-specific function
