...
export const TOOL_DEFINITION = {
  ...
  inputSchema: {
    ...
    properties: {
      ...
      with_short_descriptions: { type: "boolean", description: "[read-only] Include short descriptions" }
    },
    required: ["parent_name", "parent_tech_name", "parent_type", "node_id"]
  }
} as const;

import { McpError, ErrorCode, fetchNodeStructure, return_error, return_response } from '../../../lib/utils';
