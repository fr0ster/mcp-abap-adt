...
export class McpHandlers  {
   ...
   */
  public RegisterAllToolsOnServer(server: McpServer) {
    ...
    this.registerToolOnServer(server, UpdateTableLow_Tool.name, UpdateTableLow_Tool.description, UpdateTableLow_Tool.inputSchema as any, handleUpdateTableLow);
    this.registerToolOnServer(server, UpdateTableHigh_Tool.name, UpdateTableHigh_Tool.description, UpdateTableHigh_Tool.inputSchema as any, handleUpdateTableHigh);
    ...
    this.registerToolOnServer(server, UpdateStructureLow_Tool.name, UpdateStructureLow_Tool.description, UpdateStructureLow_Tool.inputSchema as any, handleUpdateStructureLow);
    this.registerToolOnServer(server, UpdateStructureHigh_Tool.name, UpdateStructureHigh_Tool.description, UpdateStructureHigh_Tool.inputSchema as any, handleUpdateStructureHigh);
    ...
    this.registerToolOnServer(server, CreateServiceDefinition_Tool.name, CreateServiceDefinition_Tool.description, CreateServiceDefinition_Tool.inputSchema as any, handleCreateServiceDefinition);
    this.registerToolOnServer(server, UpdateServiceDefinition_Tool.name, UpdateServiceDefinition_Tool.description, UpdateServiceDefinition_Tool.inputSchema as any, handleUpdateServiceDefinition);
    ...
    this.registerToolOnServer(server, UpdateFunctionGroup_Tool.name, UpdateFunctionGroup_Tool.description, UpdateFunctionGroup_Tool.inputSchema as any, handleUpdateFunctionGroup);
    ...
    this.registerToolOnServer(server, CreateBehaviorImplementation_Tool.name, CreateBehaviorImplementation_Tool.description, CreateBehaviorImplementation_Tool.inputSchema as any, handleCreateBehaviorImplementation);
    this.registerToolOnServer(server, UpdateBehaviorImplementation_Tool.name, UpdateBehaviorImplementation_Tool.description, UpdateBehaviorImplementation_Tool.inputSchema as any, handleUpdateBehaviorImplementation);
