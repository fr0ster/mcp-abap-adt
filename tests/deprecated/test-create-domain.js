...
async function testCreateDomain() {
  ...
  for (const testCase of testCases) {
    ...
    try {
      debugLog('HANDLER_CALL', `Calling handleCreateDomain with params`, testArgs);

      const result = await handleCreateDomain(testArgs);

      debugLog('HANDLER_RESULT', `Received result from handleCreateDomain`, {
      ...
      debugLog('HANDLER_ERROR', `Error during handleCreateDomain execution`, {
