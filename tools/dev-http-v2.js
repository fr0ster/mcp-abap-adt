...
function ensureDistExists(entryPath) {
  if (!fs.existsSync(entryPath)) {
    process.stderr.write('[dev-http-v2] dist/lib/servers/launcher.js not found. Run "npm run build" first.\n');
    process.exit(1);
  }
}
...
(function main() {
  const entryPath = path.resolve(__dirname, '../dist/lib/servers/launcher.js');
